...
hiring-detail = Estamos contratando un asistente para los fundadores (Asistente Ejecutivo/Gestor de oficina). La ubitación es San Francisco.
...
contact-us = <a href="mailto:hello@chia.network">Contactanos</a> para saber más.
